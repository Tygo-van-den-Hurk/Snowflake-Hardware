module.exports = {
  ...
  body: (params) => `
    (module Button_Switch_SMD:SW_SPDT_PCM12 (layer F.Cu) (tedit 5A02FC95)
      ...
      ${params.at /* parametric position */}
      (descr "Ultraminiature Surface Mount Slide Switch, right-angle, https://www.ckswitches.com/media/1424/pcm.pdf")
      (fp_text reference "${params.ref}" (at 0 0 ${params.rot}) (layer F.SilkS) ${params.ref_hide} (effects (font (size 1.27 1.27) (thickness 0.15))))
      (fp_text value "" (at 0 0 ${params.rot}) (layer F.SilkS) hide (effects (font (size 1.27 1.27) (thickness 0.15))))
      (attr smd)
      ...
      (pad "" np_thru_hole circle (at -1.5 0.33 ${params.rot}) (size 0.9 0.9) (drill 0.9) (layers *.Cu *.Mask))
      (pad "" np_thru_hole circle (at 1.5 0.33 ${params.rot}) (size 0.9 0.9) (drill 0.9) (layers *.Cu *.Mask))
      (pad 1 smd rect (at -2.25 -1.43 ${params.rot}) (size 0.7 1.5) (layers F.Cu F.Paste F.Mask) ${params.from.str})

      (pad 2 smd rect (at 0.75 -1.43 ${params.rot}) (size 0.7 1.5) (layers F.Cu F.Paste F.Mask) ${params.to.str})
      (pad "" smd rect (at 2.25 -1.43 ${params.rot}) (size 0.7 1.5) (layers F.Cu F.Paste F.Mask))
      (pad "" smd rect (at -3.65 1.43 ${params.rot}) (size 1 0.8) (layers F.Cu F.Paste F.Mask))
      (pad "" smd rect (at 3.65 1.43 ${params.rot}) (size 1 0.8) (layers F.Cu F.Paste F.Mask))
      (pad "" smd rect (at 3.65 -0.78 ${params.rot}) (size 1 0.8) (layers F.Cu F.Paste F.Mask))
      (pad "" smd rect (at -3.65 -0.78 ${params.rot}) (size 1 0.8) (layers F.Cu F.Paste F.Mask))

      (pad "" np_thru_hole circle (at -1.5 0.33 ${params.rot}) (size 0.9 0.9) (drill 0.9) (layers *.Cu *.Mask))
      (pad "" np_thru_hole circle (at 1.5 0.33 ${params.rot}) (size 0.9 0.9) (drill 0.9) (layers *.Cu *.Mask))
      (pad 1 smd rect (at 2.25 -1.43 ${params.rot}) (size 0.7 1.5) (layers B.Cu B.Paste B.Mask) ${params.from.str})

      (pad 2 smd rect (at -0.75 -1.43 ${params.rot}) (size 0.7 1.5) (layers B.Cu B.Paste B.Mask) ${params.to.str})
      (pad "" smd rect (at -2.25 -1.43 ${params.rot}) (size 0.7 1.5) (layers B.Cu B.Paste B.Mask))
      (pad "" smd rect (at 3.65 1.43 ${params.rot}) (size 1 0.8) (layers B.Cu B.Paste B.Mask))
      (pad "" smd rect (at -3.65 1.43 ${params.rot}) (size 1 0.8) (layers B.Cu B.Paste B.Mask))
      (pad "" smd rect (at -3.65 -0.78 ${params.rot}) (size 1 0.8) (layers B.Cu B.Paste B.Mask))
      (pad "" smd rect (at 3.65 -0.78 ${params.rot}) (size 1 0.8) (layers B.Cu B.Paste B.Mask))
    )
  `,
};
